...
//same as in N2ST
ir::ec ir::S2STDatabase::_init(const syschar *filepath, create_mode mode, bool opposite) noexcept
{
	#ifdef _WIN32
...
//Same as in N2NT
ir::S2STDatabase::S2STDatabase(const syschar *filepath, create_mode createmode, ec *code, bool) noexcept
{
